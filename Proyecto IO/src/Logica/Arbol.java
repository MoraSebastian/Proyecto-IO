...
public class Arbol {
	...
	public void construirArbol() {
		...
		Nodo n1121 = new Nodo (1, "Catalina lo observa con cara extrañada y algo incómoda le responde "
		...
		Nodo n11211 = new Nodo(1, "Catalina visiblemente aliviada le da su número a Morita. Se despiden,"
		...
		Nodo n112111 = new Nodo (1, "Ella responde: Bien y tú? Morita continúa la conversación con un "
		...
		Nodo n112112 = new Nodo (2, "Catalina le responde diciendole la disponibilidad que tiene. Ahora"
		...
		Nodo n1121122 = new Nodo(1, "Morita y Catalina se dirigen a un bar cercano a la universidad. "
		...
		Nodo n1121121 = new Nodo(2, "A catalina le agrada la idea de ir a comer bonice, Morita espera"
		...
		Nodo n11211211 = new Nodo(1, "Morita y Catalina salen a comer bonice, tienen una buena charla y "
		...
		Nodo n11211212 = new Nodo (2, "Al ver que llueve, Morita le propone ir a comer empanadita de "
		...
		Nodo n112112121 = new Nodo(1, "Catalina no pone problema y se dirigen a la tienda donde venden "
		...
		Nodo n1121121211 = new Nodo(1, "Morita y Catalina continuan hablando y coqueteando por un rato, "
		...
		Nodo n1121121212 = new Nodo(2, "Morita y Catalina continuan hablando y coqueteando por un rato, "
		...
		Nodo n112112122 = new Nodo(2, "Durante el mes, en Bogotá no dejó de llover. Morita se quedó esperando...");
		n112112122.setTipo(n112112122.TERMINAL);
		n112112122.agregarOpcion("MUY DEMALAS HERMANO.");
		
		//Nodo 1.1.2.1.1.2.1.1.1 Pedirle la cita  --------------    ----------------
		Nodo n112112111 = new Nodo(1, "En ese momento Morita mira a Catalina a los ojos y le dice que pasó "
		...
		Nodo n112112112 = new Nodo(2, "Mientras se dirigían a la universidad, en el semáforo de la carrera 13,"
		...
		Nodo n11211221 = new Nodo (1, "Es la peor decisión que Morita pudo haber tomado en su vida. No"
		...
		Nodo n11211222 = new Nodo (1, "El jugo de mora fue una buena idea. Le hizo gracia a Catalina, ya "
		...
		Nodo n11212 = new Nodo (1, "Morita y Catalina se dirigen a un bar cercano a la universidad. "
				+ "Cada uno pide una cerveza. Como siente que Catalina está algo incómoda por el lugar "
		...
		Nodo n112121 = new Nodo (1, "Es la peor decisión que Morita pudo haber tomado en su vida. "
		...
		Nodo n112122 = new Nodo(2, "El jugo de mora fue una buena idea. Le hizo gracia a Catalina, ya que "
		...
		Nodo n121 = new Nodo (1, "Y esa fue la única y última vez que Morita habló con X.");
		...
		Nodo n122 = new Nodo (2, "Morita se sorprende de la facilidad con la que consiguió aquella"
		...
		Nodo n1221 = new Nodo (1, "Morita prefiere no arriesgarse y da la iniciativa para iniciar "
		...
		Nodo n12211 = new Nodo (1, "X no pone problema y se dirigen a la tienda donde venden "
		...
		Nodo n122111 = new Nodo (1, "Morita y X continuan hablando y coqueteando por un rato, "
		...
		Nodo n122112 = new Nodo (2, "Morita y X continuan hablando y coqueteando por un rato, tienen"
		...
		Nodo n1222 = new Nodo (2, "ESPERÓ, ESPERÓ Y SE QUEDO ESPERANDO ....");
		n1222.setTipo(n1222.TERMINAL);
		
		//Nodo 1.2.2.1.2 Ir a comer helado
		Nodo n12212 = new Nodo (2, "Llegó el día esperado. Le pareció verla radiante ese día, no "
		...
		Nodo n122121 = new Nodo(1, "X le mira agradecida y se sientan a comer el helado. Cada vez "
		...
		Nodo n1221211 = new Nodo (1, "Morita se acerca cada vez más, e intenta darle un beso, ella"
		...
		Nodo n1221212 = new Nodo (2, "Morita dice estas palabras y el momento se vuelve inmediatamente"
		...
		Nodo n122122 = new Nodo (2, "Ambos se sientan a comer helado. Cada vez la charla se hace "
		...
		Nodo n1221221 = new Nodo (1, "Morita dice estas palabras y el momento se vuelve inmediatamente "
				+ "incómodo. Ella algo apenada le dice: 'Lo siento, pero tengo novio'.");
		...
		Nodo n1221222= new Nodo (2, "Estuvieron hablando por un buen rato hasta que terminaron el helado"
